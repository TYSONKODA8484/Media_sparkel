...
function Navbar() {
  ...
  useEffect(()=>{
    if(theme==="dark"){
      ...
      document.body.classList.add("darl"); 
    }else{
  ...
  return (
    ...
    ${sticky ? "sticky-navbar-md bg-base-200 duration-200 transition-all ease-in-out" : ""}`}>
      <div className={`navbar bg-base-100${sticky ? "sticky-navbar-md bg-base-200 duration-200 transition-all ease-in-out" : ""} `}>
